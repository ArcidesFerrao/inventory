...
-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('SERVICE', 'STOCK');
...
-- AddForeignKey
ALTER TABLE "RecipeItem" ADD CONSTRAINT "RecipeItem_stockId_fkey" FOREIGN KEY ("stockId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
